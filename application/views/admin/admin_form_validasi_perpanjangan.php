                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          ...
                          ?>
                          <h5 class="card-title text-primary">Form Validasi Perpanjangan SIP🎉</h5>
                          <p class="mb-4">
                              ...
                              <div class="modal-body"> 
                                <div class="row">
                                  <div class="col mb-3 align-center">
                                    ...
                                    <br>
                                    <br>
                                    <form method="POST" action="<?php echo base_url();?>administrator/aksi_validasi_perpanjangan/<?php echo $this->uri->segment(3);?>/<?php echo $datasip['id_user'];?>">
                                      <?php 
                                        $id = $datasip['id'];
