                            ...
                            <tbody class="">
                                ...
                                <?php foreach ($sip as $data) {
                                  ...
                                  elseif($data['status']==11){
                                    $status= 'Validasi Kabag';
                                    $alert = 'info';
                                  }
                                  elseif($data['status']==14){
                                    $status= 'Validasi Kadin';
                                    $alert = 'success';
                                  }
                                  ...
                                  echo '  
                                    ...
                                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>'.$validasi['tgl_validasi_sekdin'].'</strong></td>
