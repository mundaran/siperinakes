                            ...
                            <tbody class="">
                                ...
                                <?php foreach ($sip as $dataSip) {
                                  ...
                                  echo '
                                    ...
                                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><a href="'.base_url().'sekdin/form_validasi_sip/'.$dataSip['id'].'" class="btn btn-sm btn-primary"><span class="tf-icons bx bx-note"></span>&nbsp; Validasi</a></strong></td>
