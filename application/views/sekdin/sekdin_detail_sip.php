                         ...
                         <div class="table-responsive text-nowrap">
                          <table id="" class="table table-borderless">
                            ...
                            <tbody class="">
                                    ...
                                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>:</strong></td>
                                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?php echo $detail_sip['hari_awal_praktek']?>
                                    </tr>

                                    <tr>
                                      <td>&nbsp;&nbsp;
                                        <a href="<?php echo base_url();?>sekdin/print_sip/<?php echo $this->uri->segment(3);?>" type="button" target="_blank" class="btn rounded-pill btn-primary">
