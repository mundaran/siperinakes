          ...
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              <span class="app-brand-logo demo">
                <img src="<?php echo base_url();?>template/assets/img/favicon/icon_bjn.png" alt class="w-px-30 h-auto" />
                  <defs>
                    <path
                            ...
                            if($sm['badges']==51){
                              echo '<li class="menu-item active">'.
                                '<a href="'.base_url($sm['url']).'" class="menu-link">'.
                                  ...
                                  <span class="badge badge-center rounded-pill bg-primary">'.$kadin.'</span>
                                </a>
                              </li>';
                            }elseif($sm['badges']==2){
                              echo '<li class="menu-item active">'.
                            ...
                            if($sm['badges']==51){
                              echo '<li class="menu-item">'.
                                '<a href="'.base_url($sm['url']).'" class="menu-link">'.
                                  '<i class="menu-icon '.$sm['icon'].'"></i>
                                  <div data-i18n="Analytics">'.$sm['title'].'</div>&nbsp &nbsp &nbsp
                                  <span class="badge badge-center rounded-pill bg-label-primary">'.$kadin.'</span>
                                </a>
                              </li>';
                            }elseif($sm['badges']==2){
                              echo '<li class="menu-item">'.
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item lh-1 me-3">
                 ...
                 <ul style="font-size: 12px;">Kepala Dinas Kesehatan</ul>
                </li>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            ...
                            <?php
                            if($user['role_id']==51){
                              echo'<small class="text-muted">Kadin</small>';
                            }
                            else{
                    ...
                    <li>
                      <a class="dropdown-item" href="<?php echo base_url()?>kadin/my_profile">
