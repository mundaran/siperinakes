...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?php echo base_url();?>template/assets/img/favicon/icon_bjn.png" />
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>template/assets/vendor/fonts/boxicons.css" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="<?php echo base_url();?>template/assets/vendor/css/core.css" class="template-customizer-core-css" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?php echo base_url();?>template/assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
