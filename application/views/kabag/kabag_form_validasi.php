                              ...
                              <div class="modal-body"> 
                                <div class="row">
                                  <div class="col mb-3 align-center">
                                    ...
                                    <br>
                                    <br>
                                    <form method="POST" action="<?php echo base_url();?>kabag/aksi_konfirmasi_sekdin/<?php echo $this->uri->segment(3);?>/<?php echo $datasip['id_user'];?>">
                                      <input type="hidden" value="1" name="status_validasi">
                                      <input type="hidden" value="validasi kabag" name="keterangan">
                                      <input type="hidden" value="valid" name="validasi_kabag">
                                      <input type="hidden" name="status_sip" value="12">
                                    ...
                                    <button type="submit" class="btn btn-primary">Konfirmasi Sekdin</button>
                                    </form>
                                  </div>
                                  </div>
                                </div>
