              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" action="<?php echo base_url();?>kabag/aksi_edit_profile" >
                        <div class="row">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <form id="formAccountDeactivation" method="POST" action="<?php echo base_url();?>kabag/aksi_ubah_password">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content ">
            ...
            <div class="modal-body">
              <form method="POST" enctype="multipart/form-data" action="<?php echo base_url();?>kabag/upload_foto">
              <div class="row">
                <div class="col mb-3">
